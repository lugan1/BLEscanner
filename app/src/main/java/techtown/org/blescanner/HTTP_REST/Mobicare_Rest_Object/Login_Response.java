...
public class Login_Response {
    ...
    public Login_Response.data getData() {
        return data;
    }
    ...
    public String string(){
        ...
        if(getData() != null){
            Login_Response.data.userAccount userAccount = getData().getUserAccount();
            Login_Response.data.organization organization = getData().getOrganization();
            body = body +
                    "\ndata : "+
                    "\n  userAccount {"+
    ...
    public class data{
        public Login_Response.data.userAccount getUserAccount() {
            return userAccount;
        }

        public Login_Response.data.organization getOrganization() {
            return organization;
        }
